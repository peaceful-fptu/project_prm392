...
public class MainActivity extends AppCompatActivity {
    ...
    private void bottomNavigation() {
        ...
        floatingActionButton.setOnClickListener(v -> startActivity(new Intent(MainActivity.this, CartListActivity.class)));
    ...
    private void recyclerViewPopular() {
        ...
        RecyclerView.Adapter<PopularAdapter.ViewHolder> adapter2 = new PopularAdapter(foodlist);
